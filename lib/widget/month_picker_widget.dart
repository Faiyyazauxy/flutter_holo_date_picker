...
class MonthPickerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _MonthPickerWidgetState(this.firstDate, this.lastDate, this.initialDate);
}
...
class _MonthPickerWidgetState extends State<MonthPickerWidget> {
            ...
            child: Container(
              ...
              child: CupertinoPicker(
                ...
                children: List<Widget>.generate(
                  ...
                  (index) => _renderMonthPickerItemComponent(
  ...
  Widget _renderMonthPickerItemComponent(
      int value, String format, double fontSize) {
    return Container(
      height: widget.pickerTheme.itemHeight,
      alignment: Alignment.center,
      child: Text(
        DateTimeFormatter.formatDateTimeForMonth(value, format, widget.locale),
        style: TextStyle(
